  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Lenssion Homepage" />
      ...
      <Flex>
        ...
        <Flex direction="column" ml="4rem">
          ...
          <Divider mt="1rem" mb="1rem" orientation='horizontal' />
          <Text as="b">Delegation</Text>
          <Input mt="0.5rem"
            placeholder={"0x..."}></Input>
          <Button mt="0.5rem" colorScheme='blue'>Delegate</Button>
        </Flex>
        <Flex direction="column" ml="4rem">
